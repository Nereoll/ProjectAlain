...
class Lore:
    """
    Classe représentant l'écran du lore du jeu.
    ...
    def _draw(self):
        ...
        self._draw_section(
            ...
            [   
                ...
                "Depuis ce jour, la lignée des chevaliers invisibles est crainte et détestée.",
                "Aujourd’hui, c’est toi qui reprends ce fardeau. Tu es Alain Visible,",
                "le nouveau chevalier invisible. Ton pouvoir : te volatiliser pour",
                "tromper et surpasser tes ennemis.",
                "Mais l’ombre du passé revient : Gaethan Gible, chef de la faction",
                "rouge et fils de l’adversaire de Méhdi, nourrit une haine féroce",
                "envers tout chevalier invisible. Pour assouvir sa vengeance, il",
                "a capturé la princesse Pharah et l’a rendue introuvable."
            ],
            pos=(self.screen.get_width() - 750, 180),
            align="left"
        )
